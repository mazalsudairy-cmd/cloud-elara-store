  ...
  const storeSettings = [
    {
      ...
      hero_title_ar: 'منتجات وخدمات رقمية بأسعار تناسبك',
      hero_title_en: 'Digital products & services at fair prices',
      hero_subtitle_ar: 'تسليم فوري · دعم سريع · تجربة شراء واضحة وآمنة',
      hero_subtitle_en: 'Instant delivery · fast support · a clear, secure checkout',
      hero_overlay_opacity: 0.45,
      hero_image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1600&q=80',
      logo_url: '',
      theme_preset: 'violet',
      promo_bar_enabled: true,
      promo_bar_text_ar: 'عرض لفترة محدودة: خصومات على المنتجات الرقمية · تسليم فوري بعد الدفع',
      promo_bar_text_en: 'Limited-time offer: discounts on digital products · instant delivery after payment',
      banners_json: JSON.stringify([
        {
          image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1600&q=80',
          title_ar: 'منتجات وخدمات رقمية بأسعار تناسبك',
          title_en: 'Digital products & services at fair prices',
          subtitle_ar: 'تسليم فوري · دعم سريع · تجربة شراء آمنة',
          subtitle_en: 'Instant delivery · fast support · secure checkout',
          cta_ar: 'تسوّق الآن',
          cta_en: 'Shop now',
          link: '/products',
        },
        {
          ...
          title_ar: 'باقات وقوالب جاهزة للإطلاق السريع',
          title_en: 'Ready-made bundles for a fast launch',
          subtitle_ar: 'اختر الباقة المناسبة وابدأ خلال دقائق',
          subtitle_en: 'Pick a bundle and get started in minutes',
          cta_ar: 'تصفح الأقسام',
          cta_en: 'Browse categories',
          link: '/categories',
        },
      ]),
      testimonials_json: JSON.stringify([
        { name: 'عبدالله', text_ar: 'تعامل ممتاز وسريع، أنصح فيه بشدة.', text_en: 'Excellent and fast service, highly recommend.', rating: 5 },
        { name: 'سارة', text_ar: 'وصلني المنتج فوراً والدعم ما قصّر.', text_en: 'Got my product instantly and support was great.', rating: 5 },
        { name: 'Mohammed', text_ar: 'أسعار حلوة وجودة عالية، شكراً لكم.', text_en: 'Great prices and quality, thank you.', rating: 5 },
        { name: 'نورة', text_ar: 'تجربة شراء سهلة وآمنة، بتعامل معكم مرة ثانية.', text_en: 'Easy, secure checkout. Will buy again.', rating: 5 },
      ]),
      whatsapp_enabled: false,
      whatsapp_number: '',
      section_visibility_json: JSON.stringify({
        categories: true,
        featured: true,
        bestSellers: true,
        newArrivals: true,
      ...
      ui_nav_labels_json:
        '{"home":{"ar":"","en":""},"products":{"ar":"","en":""},"categories":{"ar":"","en":""},"shopNow":{"ar":"","en":""},"exploreServices":{"ar":"","en":""}}',
      custom_site_css: '',
      theme_background: '',
      theme_navy: '',
      theme_navy_mid: '',
