      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <Link to="/" className="flex items-center gap-2.5">
            <span className="text-xs font-display font-bold tracking-[0.3em] uppercase text-foreground/80">
          ...
          <div className="flex items-center gap-2">
            ...
            {user?.role === 'admin' && (
              <Link to="/admin" className="hidden md:flex items-center p-2 text-foreground/30 hover:text-foreground/70 transition-colors rounded-lg">
